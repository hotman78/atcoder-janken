...
function make_table() {
    ...
    tblBody.append(`<tr><td colspan="3" align="center"><strong>${p1}の${s}勝${t}負${u}引き分け</strong>です。<a href="https://twitter.com/share" class="twitter-share-button" data-url="https://hotman78.github.io/atcoder-janken/" data-text="${p1}の${s}勝${t}負${u}引き分けです。" data-related="hotmanww" data-hashtags="#Atcoderじゃんけん">Tweet</a></td></tr>`);
