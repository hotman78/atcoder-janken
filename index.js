function vs() {
    ...
    }
    {
        ...
        tblBody.empty();
        var s=0,t=0,u=0;
        for (const [key, value1] of Object.entries(val1).reverse()) {
        ...
        tblBody.append(`<tr><td colspan="4" align="center"><strong>${s==t?`${t}勝${s}負${u}引き分けで引き分けです！！`:s<t?`${t}勝${s}負${u}引き分けで${p2}の勝利です！！`:`${s}勝${t}負${u}引き分けで${p1}の勝利です！！`}</strong><a href="https://twitter.com/share" class="twitter-share-button" data-text="【AtCoderじゃんけん】\n${p1} vs ${p2}\n${s}対${t}で${s==t?"引き分けです！！":(s<t?`${p2}の勝利です！！`:`${p1}の勝利です！！`)}\n(${st.toLocaleDateString()}~${ed.toLocaleDateString()})#Atcoderじゃんけん" data-url="https://hotman78.github.io/atcoder-janken/" data-related="hotmanww">Tweet</a></td></tr>`);
